...
export const esPY = {
  ...
  "panel.ajustes.marca.nombre": "Nombre de la tienda:",
  "panel.ajustes.marca.nombreAyuda":
    "El nombre vive en el código (src/config/tienda.ts) porque también es el título de cada página y el remitente de los mensajes. Para cambiarlo, pedíselo al desarrollador.",
